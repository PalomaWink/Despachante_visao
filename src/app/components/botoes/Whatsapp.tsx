    ...
    <button className="whatsapp-button">
      ...
      <style jsx>{`
        ...
        .whatsapp-button:hover:after {
          ...
          .whatsapp-button > svg {
            height: 24px; /* Menor para telas até 428px */
          }
          .whatsapp-button {
            font-size: 16px; /* Opcional: Reduzir o tamanho do texto */
          }
        }

        @media (max-width: 320px) {
          .whatsapp-button > svg {
            height: 20px; /* Ainda menor para telas até 320px */
          }
          .whatsapp-button {
            font-size: 14px; /* Opcional: Reduzir ainda mais o tamanho do texto */
          }
        }
      `}</style>
    </button>
